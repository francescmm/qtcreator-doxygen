...
export QT_CREATOR=$PWD/bin/QtCreator.app/
export PATH="/usr/local/opt/qt/bin:$QT_CREATOR:$PATH"
export QT_PLUGIN_PATH=$PWD/qt5/plugins;
export PLUGIN_VERSION="0.4.8";
source ~/.bash_profile
qmake QTC_SOURCE=./qt-creator-opensource-src-${QTC_VERSION}.0 QTC_BUILD=${QT_CREATOR} QMAKE_RPATHDIR=${QT_CREATOR} doxygen.pro
make
